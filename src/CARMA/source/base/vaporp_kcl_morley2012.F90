...
!! @version Feb-2011
subroutine vaporp_kcl_morley2012(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of KCl from Morley et al. (2012). 

  pvap_liq = 1e6_f * 10._f ** (7.6106_f - TCOEFF_KCL/t(iz))
  pvap_ice = pvap_liq
