...
!! @version Feb-2011
subroutine vaporp_fe_visscher2010(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of Fe from Visscher et al. (2010). 

  pvap_liq = 1e6_f * 10._f ** (7.23_f - TCOEFF_FE/t(iz))
  pvap_ice = pvap_liq
