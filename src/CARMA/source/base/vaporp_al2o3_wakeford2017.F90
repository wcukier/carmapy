...
!! @version Feb-2011
subroutine vaporp_al2o3_wakeford2017(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of Al2O3 estimated from Wakeford et al. (2017)

  pvap_liq = 1e6_f * 10._f ** (17.7_f - TCOEFF_AL2O3/t(iz) - 1.66*met)
  pvap_ice = pvap_liq
