...
!! @version Feb-2011
subroutine vaporp_zns_morley2012(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of ZnS from Morley et al. (2012). 

  pvap_liq = max(1e-60_f,1e6_f * 10._f ** (12.812_f - TCOEFF_ZNS/t(iz) - met))
  pvap_ice = pvap_liq
