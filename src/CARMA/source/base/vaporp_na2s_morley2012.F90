...
!! @version Feb-2011
subroutine vaporp_na2s_morley2012(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of Na2S from Morley et al. (2012). 

  pvap_liq = 1e6_f * 10._f ** (8.55_f - TCOEFF_NA2S/t(iz) - 0.5_f * met)
  pvap_ice = pvap_liq
