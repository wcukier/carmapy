...
!! @version Feb-2011
subroutine vaporp_mns_morley2012(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of MnS from Morley et al. (2012). 

  pvap_liq = 1e6_f * 10._f ** (11.532_f - TCOEFF_MNS/t(iz) - met)
  pvap_ice = pvap_liq
