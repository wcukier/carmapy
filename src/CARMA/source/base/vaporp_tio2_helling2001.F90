...
!! @version Feb-2011
subroutine vaporp_tio2_helling2001(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of TiO2 from Helling et al. (2001)

  pvap_liq = 1e6_f * 10._f ** (9.5489_f - TCOEFF_TIO2_HELLING/t(iz))
  pvap_ice = pvap_liq
